pub fn rope(vec: &mut [f32], base: f32, pos: u32, head_dim: u32, rotary_dim: u32) {
    ...
    assert!(end % 2 == 0, "RoPE rotary span must be even");
    let num_pairs = end / 2;
...
mod test {
    ...
    fn test_rope_dim4_pairs_non_overlapping() {
        ...
        super::rope(&mut v[..], 10000.0, 0, 4, 4);
